      ...
      <main className="min-h-screen bg-[#0a1020] text-white pt-24 pb-24">
        ...
        <section className="max-w-5xl mx-auto px-6 mb-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
            Automation guides for <span className="text-electric">Ugandan businesses</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <Link
            ...
            className="group block bg-[#0d1526] border border-white/8 rounded-2xl overflow-hidden hover:border-electric/40 transition-all duration-300 mb-10"
          >
            <div className="p-8 md:p-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white group-hover:text-electric transition-colors mb-3">
                {featured.title}
              </h2>
              <p className="text-white/60 text-base leading-relaxed mb-5 max-w-3xl">
                {featured.description}
              </p>
              <span className="inline-flex items-center gap-2 text-electric font-semibold text-sm group-hover:gap-3 transition-all">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {rest.map((post) => (
              <Link
                key={post.slug}
                href={`/blog/${post.slug}`}
                className="group block bg-[#0d1526] border border-white/8 rounded-2xl p-7 hover:border-electric/40 transition-all duration-300"
              >
                ...
                <span className="inline-flex items-center gap-2 text-electric text-sm font-semibold group-hover:gap-3 transition-all">
