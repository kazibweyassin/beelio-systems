...
import { servicesSchema, serviceOfferingsSchema } from '@/lib/servicesSchema';
...
export const metadata = pageMetadata({
  title: 'Custom Software & FinTech Development Services',
  description:
    'AI-powered software development, FinTech platforms, business automation, and custom software solutions. We build intelligent systems for enterprises and financial institutions.',
  path: '/services',
  keywords: [
...
export default function ServicesPage() {
  return (
    <main>
      <JsonLd data={[servicesSchema, serviceOfferingsSchema]} />
      <Header />
