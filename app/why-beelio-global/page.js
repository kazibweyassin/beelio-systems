...
export const metadata = pageMetadata({
  title: 'Why Choose Beelio for Emerging Markets',
  description:
    'Multi-location operations, white-label platforms, enterprise integrations, security compliance, and dedicated support. Why businesses choose Beelio for AI software and FinTech development.',
  path: '/why-beelio-global',
  keywords: [
    'AI software company Africa',
    'FinTech development emerging markets',
    ...
    <>
      <JsonLd
        data={breadcrumbSchema([
          { name: 'Home', href: '/' },
          { name: 'Why Beelio', href: '/why-beelio-global' },
        ])}
      />
      <Header />
