  ...
  return (
    <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-[#0a1020] border-b border-white/5">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#00e6fe]/20 border border-[#00e6fe]/30 flex items-center justify-center text-sm">
                  🤖
                </div>
                <div>
                ...
                >
                  <div
                    className={`max-w-[80%] px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${
                      msg.from === "user"
                        ? "bg-[#00e6fe] text-[#0a1020] font-medium rounded-br-sm"
                ...
                <div className="flex flex-col gap-2 mt-1">
                  {lastMessage.options.map((opt, i) => (
                    <button
                      ...
                      className="text-left text-sm px-4 py-2 rounded-xl border border-[#00e6fe]/20 text-[#00e6fe] hover:bg-[#00e6fe]/10 transition-colors duration-200"
                    >
                      {opt.label}
                    </button>
                  ))}
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-4 md:right-8 w-14 h-14 bg-[#00e6fe] text-[#0a1020] rounded-full shadow-lg flex items-center justify-center z-50 hover:bg-[#00c4d8] transition-colors duration-200"
      >
